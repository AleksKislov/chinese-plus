    ...
    post && (
      <div className='row'>
        ...
        <div className='col-sm-6'>
          <Link to='/posts'>
            <button className='btn btn-outline-info my-2 btn-sm' onClick={clearPosts}>
              Назад
            </button>
          </Link>
...
export default connect(mapStateToProps, { loadPost, getComments, clearPost, clearPosts })(PostPage);
