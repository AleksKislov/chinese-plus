        ...
        <div>
          ...
          <div>
            <p>
              ...
              <span>部首</span> <strong>bùshǒu</strong>, то есть голова раздела, имеется в виду
              главный иероглиф раздела словаря.
            </p>
            ...
            <p>
              ...
              <strong className='text-warning'>оранжевым цветом</strong>, иероглифы с этими ключами
              вам будут встречаться чаще всего. Речь про эти ключи: 艹 трава (№140), 水 вода (№85),
              木 дерево (№75), 扌рука (№64), 口 рот (№30), 心 сердце (№61), 虫 насекомое (№142), 竹
              бамбук (№118), 言 речь (№149) и 纟 нить (№120).
            </p>

            <p>
              <strong className='text-info'>Ключи на синем фоне</strong> тоже будут вам довольно
              часто встречаться в иероглифах. В целом, когда уже и зеленые, и оранжевые хорошо
              усвоены, стоит запомнить и остальные.
            </p>
            ...
            <p>
              ...
              "человек" в левой части иероглифа 亻- это 单人旁 (буквально одинокий человек сбоку,
              например, как в иероглифе 休), а вот ключ "человек" сверху - это 人字头 (букв.
              человек-иероглиф-голова, то есть "человек" на голове иероглифа, например, как в
              иероглифе 会). Если ключ расположен в нижней части иероглифа, то часто название
              принимает такой вид 皿字底 (то есть ключ 皿 "сосуд" снизу иероглифа, например, как в
              иероглифе 蓝).
            </p>
