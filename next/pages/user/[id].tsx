...
import AllUserTextsTable from "../../components/profile/AllUserTextsTable";
...
const UserProfile = ({}) => {
  ...
  useEffect(() => {
    if (router.query.id) loadProfile(router.query.id);
  }, [router.query.id]);
  ...
  return profile ? (
    <div className='row'>
      <div className='col-md-12'>
        <button className='btn btn-outline-info my-2 btn-sm' onClick={router.back}>
          Назад
        </button>
      </div>
      ...
      <div className='col-md-11'>
        ...
        <div className=''>
          <AllUserTextsTable userId={router.query.id} />
        </div>
        <div className=''>
