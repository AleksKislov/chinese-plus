...
import { faHeart, faSort, faEye, faCommentDots } from "@fortawesome/free-solid-svg-icons";
                ...
                <Tippy content='Кол-во благодарностей' placement='top'>
                  <th style={thStyle}>
                    <div onClick={sortByLikes}>
                      <FontAwesomeIcon icon={faHeart} /> <FontAwesomeIcon icon={faSort} />
                    </div>
                  </th>
                </Tippy>
                <Tippy content='Кол-во просмотров' placement='top'>
                  <th style={thStyle}>
                    <div onClick={sortByHits}>
                      <FontAwesomeIcon icon={faEye} /> <FontAwesomeIcon icon={faSort} />
                    </div>
                  </th>
                </Tippy>
                <Tippy content='Кол-во комментариев' placement='top'>
                  <th style={thStyle}>
                    <div onClick={sortByComments}>
                      <FontAwesomeIcon icon={faCommentDots} /> <FontAwesomeIcon icon={faSort} />
                    </div>
                  </th>
                </Tippy>
              </tr>
